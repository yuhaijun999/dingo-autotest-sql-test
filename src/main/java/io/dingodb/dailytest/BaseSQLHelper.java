...
//    public BaseSQLHelper(Connection connection) {
//        this.connection = connection;
//    }

    public void execFile(@Nonnull Connection connection, InputStream stream, String replaceTableName) throws IOException, SQLException {
    ...
    public void execSql(Connection connection, String sql) throws SQLException {
        try (Statement statement = connection.createStatement()) {
            if (!sql.trim().isEmpty()) {
    ...
    public void execBatchSqlWithState(Connection connection, String sql) throws SQLException {
        try (Statement statement = connection.createStatement()) {
            for (String s : sql.split(";")) {
                if (!s.trim().isEmpty()) {
                    statement.execute(s);
    ...
    //dml操作只返回影响行数
    public int doDMLReturnRows(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
    ...
    public List<List<String>> doDMLAndQueryWithHead(Connection connection, String dmlSql, String querySql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
    ...
    //查询返回结果行数
    public int queryWithRowsNumReturn(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
    ...
    public Object queryWithObjReturn(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public String queryWithStrReturn(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public Double queryWithDoubleReturn(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public List<List<String>> statementQuery(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public List<List<String>> statementQueryWithHead(Connection connection, String sql) throws SQLException {
        try(Statement statement = connection.createStatement()) {
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public List<List<String>> preparedStatementQuery(Connection connection, String sql, String[] value_type, Object ... values) throws SQLException {
    ...
    public int preparedStatementDMLGetRows(Connection connection, String dml_sql, String[] value_type, Object ... values) throws SQLException {
    ...
    public List<List<String>> preparedStatementDMLGetData(Connection connection, String dml_sql, String query_sql, String[] value_type, Object ... values) throws SQLException {
    ...
    public void preparedStatementBatchInsert(Connection connection, 
    ...
    public void doDropTable(Connection connection, String tableName) throws SQLException {
        try (Statement statement = connection.createStatement()) {
    ...
    public void doDropSchema(Connection connection, String schemaName) throws SQLException {
        try (Statement statement = connection.createStatement()) {
    ...
    public void doDropDatabase(Connection connection, String databaseName) throws SQLException {
        try (Statement statement = connection.createStatement()) {
