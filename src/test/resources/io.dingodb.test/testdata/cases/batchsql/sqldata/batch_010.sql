CREATE DATABASE IF NOT EXISTS jarvex;
USE jarvex;
DROP TABLE IF EXISTS jarvex.`CHAT_QU_DATA`;
CREATE TABLE jarvex.`CHAT_QU_DATA` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`CHAT_SE_DATA`;
CREATE TABLE jarvex.`CHAT_SE_DATA` (
...
DROP TABLE IF EXISTS jarvex.`COMMENT_BASE_INFO`;
CREATE TABLE jarvex.`COMMENT_BASE_INFO` (
...
DROP TABLE IF EXISTS jarvex.`CREATIVE_BASE_INFO`;
CREATE TABLE jarvex.`CREATIVE_BASE_INFO` (
...
DROP TABLE IF EXISTS jarvex.`CREATIVE_QU_DATA`;
CREATE TABLE jarvex.`CREATIVE_QU_DATA` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`CREATIVE_SE_DATA`;
CREATE TABLE jarvex.`CREATIVE_SE_DATA` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`DATA_FILE`;
CREATE TABLE jarvex.`DATA_FILE` (
...
DROP TABLE IF EXISTS jarvex.`DATA_FILE_EXPERTISE`;
CREATE TABLE jarvex.`DATA_FILE_EXPERTISE` (
...
DROP TABLE IF EXISTS jarvex.`DATA_FILEFT`;
CREATE TABLE jarvex.`DATA_FILEFT` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`DATA_FILESET`;
CREATE TABLE jarvex.`DATA_FILESET` (
...
DROP TABLE IF EXISTS jarvex.`DATA_FT_LIST`;
CREATE TABLE jarvex.`DATA_FT_LIST` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`DATASET_DINGO`;
CREATE TABLE jarvex.`DATASET_DINGO` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`DATASET_FT_LIST`;
CREATE TABLE jarvex.`DATASET_FT_LIST` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`DEPARTMENT`;
CREATE TABLE jarvex.`DEPARTMENT` (
...
DROP TABLE IF EXISTS jarvex.`MODEL_BASE_INFO`;
CREATE TABLE jarvex.`MODEL_BASE_INFO` (
...
DROP TABLE IF EXISTS jarvex.`OPERATION`;
CREATE TABLE jarvex.`OPERATION` (
...
INSERT INTO jarvex.OPERATION (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS jarvex.`PERMISSION`;
CREATE TABLE jarvex.`PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex.PERMISSION (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS jarvex.`PERMISSIONGROUP`;
CREATE TABLE jarvex.`PERMISSIONGROUP` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex.`REL_PGROUP_PERMISSION`;
CREATE TABLE jarvex.`REL_PGROUP_PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex.`REL_PGROUP_PERMISSION` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS jarvex.`REL_ROLE_PERMISSION`;
CREATE TABLE jarvex.`REL_ROLE_PERMISSION` (
...
INSERT INTO jarvex.REL_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex.`REL_ROLE_PGROUP`;
CREATE TABLE jarvex.`REL_ROLE_PGROUP` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
...
INSERT INTO jarvex.REL_ROLE_PGROUP (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS jarvex.`REL_USER_PERMISSION`;
CREATE TABLE jarvex.`REL_USER_PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
DROP TABLE IF EXISTS jarvex.`REL_USER_ROLE`;
CREATE TABLE jarvex.`REL_USER_ROLE` (
...
INSERT INTO jarvex.REL_USER_ROLE (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS jarvex.`REL_USERGROUP_ROLE`;
CREATE TABLE jarvex.`REL_USERGROUP_ROLE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex.REL_USERGROUP_ROLE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS jarvex.`REL_USERGROUP_USER`;
CREATE TABLE jarvex.`REL_USERGROUP_USER` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
...
INSERT INTO jarvex.REL_USERGROUP_USER (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS jarvex.`RESOURCE`;
CREATE TABLE jarvex.`RESOURCE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
INSERT INTO jarvex.RESOURCE (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS jarvex.`ROLE`;
CREATE TABLE jarvex.`ROLE` (
...
INSERT INTO jarvex.`role` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex.`USER`;
CREATE TABLE jarvex.`USER` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex.`USER` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','jarvex@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','jarvex@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','jarvex@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS jarvex.`USER_BASE`;
CREATE TABLE jarvex.`USER_BASE` (
...
DROP TABLE IF EXISTS jarvex.`USERGROUP`;
CREATE TABLE jarvex.`USERGROUP` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
...
INSERT INTO jarvex.`USERGROUP` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex.`VECTOR_DATA`;
CREATE TABLE jarvex.`VECTOR_DATA` (
