CREATE DATABASE jarvex_txnbtree;
USE jarvex_txnbtree;
DROP TABLE IF EXISTS jarvex_txnbtree.`CHAT_QU_DATA_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`CHAT_QU_DATA_TXNBTREE` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`CHAT_SE_DATA_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`CHAT_SE_DATA_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`COMMENT_BASE_INFO_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`COMMENT_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`CREATIVE_BASE_INFO_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`CREATIVE_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`CREATIVE_QU_DATA_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`CREATIVE_QU_DATA_TXNBTREE` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`CREATIVE_SE_DATA_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`CREATIVE_SE_DATA_TXNBTREE` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATA_FILE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATA_FILE_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATA_FILE_EXPERTISE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATA_FILE_EXPERTISE_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATA_FILEFT_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATA_FILEFT_TXNBTREE` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATA_FILESET_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATA_FILESET_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATA_FT_LIST_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATA_FT_LIST_TXNBTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATASET_DINGO_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATASET_DINGO_TXNBTREE` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DATASET_FT_LIST_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DATASET_FT_LIST_TXNBTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`DEPARTMENT_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`DEPARTMENT` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`MODEL_BASE_INFO_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`MODEL_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`OPERATION_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`OPERATION_TXNBTREE` (
...
INSERT INTO jarvex_txnbtree.OPERATION_TXNBTREE (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`PERMISSION_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex_txnbtree.PERMISSION_TXNBTREE (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`PERMISSIONGROUP_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`PERMISSIONGROUP_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_ROLE_PERMISSION_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_ROLE_PERMISSION_TXNBTREE` (
...
INSERT INTO jarvex_txnbtree.REL_ROLE_PERMISSION_TXNBTREE (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_ROLE_PGROUP_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_ROLE_PGROUP_TXNBTREE` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
...
INSERT INTO jarvex_txnbtree.REL_ROLE_PGROUP_TXNBTREE (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_USER_PERMISSION_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_USER_PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_USER_ROLE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_USER_ROLE_TXNBTREE` (
...
INSERT INTO jarvex_txnbtree.REL_USER_ROLE_TXNBTREE (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_USERGROUP_ROLE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_USERGROUP_ROLE_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex_txnbtree.REL_USERGROUP_ROLE_TXNBTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS jarvex_txnbtree.`REL_USERGROUP_USER_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`REL_USERGROUP_USER_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
...
INSERT INTO jarvex_txnbtree.REL_USERGROUP_USER_TXNBTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`RESOURCE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`RESOURCE_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
INSERT INTO jarvex_txnbtree.RESOURCE_TXNBTREE (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`ROLE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`ROLE_TXNBTREE` (
...
INSERT INTO jarvex_txnbtree.`role_TXNBTREE` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`USER_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`USER_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex_txnbtree.`USER_TXNBTREE` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','jarvex_txnbtree@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','jarvex_txnbtree@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','jarvex_txnbtree@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS jarvex_txnbtree.`USER_BASE_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`USER_BASE_TXNBTREE` (
...
DROP TABLE IF EXISTS jarvex_txnbtree.`USERGROUP_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`USERGROUP_TXNBTREE` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
...
INSERT INTO jarvex_txnbtree.`USERGROUP_TXNBTREE` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_txnbtree.`VECTOR_DATA_TXNBTREE`;
CREATE TABLE jarvex_txnbtree.`VECTOR_DATA_TXNBTREE` (
