CREATE DATABASE IF NOT EXISTS myjarvex;
USE myjarvex;
DROP TABLE IF EXISTS myjarvex.`CHAT_QU_DATA`;
CREATE TABLE myjarvex.`CHAT_QU_DATA` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`CHAT_SE_DATA`;
CREATE TABLE myjarvex.`CHAT_SE_DATA` (
...
DROP TABLE IF EXISTS myjarvex.`COMMENT_BASE_INFO`;
CREATE TABLE myjarvex.`COMMENT_BASE_INFO` (
...
DROP TABLE IF EXISTS myjarvex.`CREATIVE_BASE_INFO`;
CREATE TABLE myjarvex.`CREATIVE_BASE_INFO` (
...
DROP TABLE IF EXISTS myjarvex.`CREATIVE_QU_DATA`;
CREATE TABLE myjarvex.`CREATIVE_QU_DATA` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`CREATIVE_SE_DATA`;
CREATE TABLE myjarvex.`CREATIVE_SE_DATA` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`DATA_FILE`;
CREATE TABLE myjarvex.`DATA_FILE` (
...
DROP TABLE IF EXISTS myjarvex.`DATA_FILE_EXPERTISE`;
CREATE TABLE myjarvex.`DATA_FILE_EXPERTISE` (
...
DROP TABLE IF EXISTS myjarvex.`DATA_FILEFT`;
CREATE TABLE myjarvex.`DATA_FILEFT` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`DATA_FILESET`;
CREATE TABLE myjarvex.`DATA_FILESET` (
...
DROP TABLE IF EXISTS myjarvex.`DATA_FT_LIST`;
CREATE TABLE myjarvex.`DATA_FT_LIST` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`DATASET_DINGO`;
CREATE TABLE myjarvex.`DATASET_DINGO` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`DATASET_FT_LIST`;
CREATE TABLE myjarvex.`DATASET_FT_LIST` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex.`DEPARTMENT`;
CREATE TABLE myjarvex.`DEPARTMENT` (
...
DROP TABLE IF EXISTS myjarvex.`MODEL_BASE_INFO`;
CREATE TABLE myjarvex.`MODEL_BASE_INFO` (
...
DROP TABLE IF EXISTS myjarvex.`OPERATION`;
CREATE TABLE myjarvex.`OPERATION` (
...
INSERT INTO myjarvex.OPERATION (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex.`PERMISSION`;
CREATE TABLE myjarvex.`PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
...
INSERT INTO myjarvex.PERMISSION (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex.`PERMISSIONGROUP`;
CREATE TABLE myjarvex.`PERMISSIONGROUP` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
	...
	PRIMARY KEY (id)
--	UNIQUE (name)
) AUTO_INCREMENT = 1000 COMMENT='权限组信息表';
DROP TABLE IF EXISTS myjarvex.`REL_PGROUP_PERMISSION`;
CREATE TABLE myjarvex.`REL_PGROUP_PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	pgroup_id INTEGER NOT NULL,
	permission_id INTEGER NOT NULL,
	PRIMARY KEY (pgroup_id, permission_id)
) AUTO_INCREMENT = 1000 COMMENT='权限组与权限关联表';
INSERT INTO myjarvex.`REL_PGROUP_PERMISSION` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex.`REL_ROLE_PERMISSION`;
CREATE TABLE myjarvex.`REL_ROLE_PERMISSION` (
...
INSERT INTO myjarvex.REL_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex.`REL_ROLE_PGROUP`;
CREATE TABLE myjarvex.`REL_ROLE_PGROUP` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
	role_id INTEGER NOT NULL,
	pgroup_id INTEGER NOT NULL,
	PRIMARY KEY (role_id, pgroup_id)
) AUTO_INCREMENT = 1000 COMMENT='角色与权限组关联表';
INSERT INTO myjarvex.REL_ROLE_PGROUP (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex.`REL_USER_PERMISSION`;
CREATE TABLE myjarvex.`REL_USER_PERMISSION` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	user_id INTEGER NOT NULL,
	permission_id INTEGER NOT NULL,
	PRIMARY KEY (user_id, permission_id)
) AUTO_INCREMENT = 1000 COMMENT='用户与权限关联表';
DROP TABLE IF EXISTS myjarvex.`REL_USER_ROLE`;
CREATE TABLE myjarvex.`REL_USER_ROLE` (
...
INSERT INTO myjarvex.REL_USER_ROLE (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS myjarvex.`REL_USERGROUP_ROLE`;
CREATE TABLE myjarvex.`REL_USERGROUP_ROLE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	role_id INTEGER NOT NULL,
	PRIMARY KEY (usergroup_id, role_id)
) AUTO_INCREMENT = 1000 COMMENT='用户组与角色关联表';
INSERT INTO myjarvex.REL_USERGROUP_ROLE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS myjarvex.`REL_USERGROUP_USER`;
CREATE TABLE myjarvex.`REL_USERGROUP_USER` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
	PRIMARY KEY (usergroup_id, user_id)
) AUTO_INCREMENT = 1000 COMMENT='用户组与用户关联表';
INSERT INTO myjarvex.REL_USERGROUP_USER (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex.`RESOURCE`;
CREATE TABLE myjarvex.`RESOURCE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
INSERT INTO myjarvex.RESOURCE (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS myjarvex.`ROLE`;
CREATE TABLE myjarvex.`ROLE` (
...
INSERT INTO myjarvex.`role` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex.`USER`;
CREATE TABLE myjarvex.`USER` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
...
INSERT INTO myjarvex.`USER` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','myjarvex@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','myjarvex@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','myjarvex@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS myjarvex.`USER_BASE`;
CREATE TABLE myjarvex.`USER_BASE` (
...
DROP TABLE IF EXISTS myjarvex.`USERGROUP`;
CREATE TABLE myjarvex.`USERGROUP` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
  ...
  `update_time` bigint NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT = 1000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户组';
INSERT INTO myjarvex.`USERGROUP` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex.`VECTOR_DATA`;
CREATE TABLE myjarvex.`VECTOR_DATA` (
