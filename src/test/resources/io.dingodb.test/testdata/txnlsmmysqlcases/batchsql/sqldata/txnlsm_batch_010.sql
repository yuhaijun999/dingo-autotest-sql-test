CREATE DATABASE IF NOT EXISTS myjarvex_txnlsm;
USE myjarvex_txnlsm;
DROP TABLE IF EXISTS myjarvex_txnlsm.`CHAT_QU_DATA_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`CHAT_QU_DATA_TXNLSM` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`CHAT_SE_DATA_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`CHAT_SE_DATA_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`COMMENT_BASE_INFO_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`COMMENT_BASE_INFO_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`CREATIVE_BASE_INFO_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`CREATIVE_BASE_INFO_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`CREATIVE_QU_DATA_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`CREATIVE_QU_DATA_TXNLSM` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`CREATIVE_SE_DATA_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`CREATIVE_SE_DATA_TXNLSM` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATA_FILE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATA_FILE_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATA_FILE_EXPERTISE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATA_FILE_EXPERTISE_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATA_FILEFT_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATA_FILEFT_TXNLSM` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATA_FILESET_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATA_FILESET_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATA_FT_LIST_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATA_FT_LIST_TXNLSM` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATASET_DINGO_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATASET_DINGO_TXNLSM` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DATASET_FT_LIST_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DATASET_FT_LIST_TXNLSM` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`DEPARTMENT_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`DEPARTMENT_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`MODEL_BASE_INFO_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`MODEL_BASE_INFO_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`OPERATION_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`OPERATION_TXNLSM` (
...
INSERT INTO myjarvex_txnlsm.OPERATION_TXNLSM (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`PERMISSION_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`PERMISSION_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
...
INSERT INTO myjarvex_txnlsm.PERMISSION_TXNLSM (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`PERMISSIONGROUP_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`PERMISSIONGROUP_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_PGROUP_PERMISSION_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_PGROUP_PERMISSION_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO myjarvex_txnlsm.`REL_PGROUP_PERMISSION_TXNLSM` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_ROLE_PERMISSION_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_ROLE_PERMISSION_TXNLSM` (
...
INSERT INTO myjarvex_txnlsm.REL_ROLE_PERMISSION_TXNLSM (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_ROLE_PGROUP_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_ROLE_PGROUP_TXNLSM` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
...
INSERT INTO myjarvex_txnlsm.REL_ROLE_PGROUP_TXNLSM (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_USER_PERMISSION_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_USER_PERMISSION_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_USER_ROLE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_USER_ROLE_TXNLSM` (
...
INSERT INTO myjarvex_txnlsm.REL_USER_ROLE_TXNLSM (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_USERGROUP_ROLE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_USERGROUP_ROLE_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO myjarvex_txnlsm.REL_USERGROUP_ROLE_TXNLSM (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS myjarvex_txnlsm.`REL_USERGROUP_USER_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`REL_USERGROUP_USER_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
...
INSERT INTO myjarvex_txnlsm.REL_USERGROUP_USER_TXNLSM (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`RESOURCE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`RESOURCE_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
INSERT INTO myjarvex_txnlsm.RESOURCE_TXNLSM (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`ROLE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`ROLE_TXNLSM` (
...
INSERT INTO myjarvex_txnlsm.`role_TXNLSM` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`USER_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`USER_TXNLSM` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
...
INSERT INTO myjarvex_txnlsm.`USER_TXNLSM` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','myjarvex_txnlsm@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','myjarvex_txnlsm@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','myjarvex_txnlsm@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`USER_BASE_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`USER_BASE_TXNLSM` (
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`USERGROUP_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`USERGROUP_TXNLSM` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
...
INSERT INTO myjarvex_txnlsm.`USERGROUP_TXNLSM` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnlsm.`VECTOR_DATA_TXNLSM`;
CREATE TABLE myjarvex_txnlsm.`VECTOR_DATA_TXNLSM` (
