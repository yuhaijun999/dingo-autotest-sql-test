CREATE DATABASE IF NOT EXISTS myjarvex_txnbtree;
USE myjarvex_txnbtree;
DROP TABLE IF EXISTS myjarvex_txnbtree.`CHAT_QU_DATA_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`CHAT_QU_DATA_TXNBTREE` (
	user_id VARCHAR(255),
...
) engine=TXN_BTREE AUTO_INCREMENT = 1000;
DROP TABLE IF EXISTS myjarvex_txnbtree.`CHAT_SE_DATA_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`CHAT_SE_DATA_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`COMMENT_BASE_INFO_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`COMMENT_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`CREATIVE_BASE_INFO_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`CREATIVE_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`CREATIVE_QU_DATA_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`CREATIVE_QU_DATA_TXNBTREE` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`CREATIVE_SE_DATA_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`CREATIVE_SE_DATA_TXNBTREE` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATA_FILE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATA_FILE_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATA_FILE_EXPERTISE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATA_FILE_EXPERTISE_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATA_FILEFT_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATA_FILEFT_TXNBTREE` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATA_FILESET_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATA_FILESET_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATA_FT_LIST_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATA_FT_LIST_TXNBTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATASET_DINGO_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATASET_DINGO_TXNBTREE` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DATASET_FT_LIST_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DATASET_FT_LIST_TXNBTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`DEPARTMENT_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`DEPARTMENT_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`MODEL_BASE_INFO_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`MODEL_BASE_INFO_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`OPERATION_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`OPERATION_TXNBTREE` (
	...
	PRIMARY KEY (id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='功能操作表';
INSERT INTO myjarvex_txnbtree.OPERATION_TXNBTREE (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`PERMISSION_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
	...
	id INTEGER NOT NULL AUTO_INCREMENT,
	PRIMARY KEY (id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='权限信息表';
INSERT INTO myjarvex_txnbtree.PERMISSION_TXNBTREE (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`PERMISSIONGROUP_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`PERMISSIONGROUP_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
	...
	PRIMARY KEY (id)
--	UNIQUE (name)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='权限组信息表';
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	pgroup_id INTEGER NOT NULL,
	permission_id INTEGER NOT NULL,
	PRIMARY KEY (pgroup_id, permission_id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='权限组与权限关联表';
INSERT INTO myjarvex_txnbtree.`REL_PGROUP_PERMISSION_TXNBTREE` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_ROLE_PERMISSION_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_ROLE_PERMISSION_TXNBTREE` (
...
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='角色权限关联表';
INSERT INTO myjarvex_txnbtree.REL_ROLE_PERMISSION_TXNBTREE (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_ROLE_PGROUP_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_ROLE_PGROUP_TXNBTREE` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
	role_id INTEGER NOT NULL,
	pgroup_id INTEGER NOT NULL,
	PRIMARY KEY (role_id, pgroup_id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='角色与权限组关联表';
INSERT INTO myjarvex_txnbtree.REL_ROLE_PGROUP_TXNBTREE (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_USER_PERMISSION_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_USER_PERMISSION_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	user_id INTEGER NOT NULL,
	permission_id INTEGER NOT NULL,
	PRIMARY KEY (user_id, permission_id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='用户与权限关联表';
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_USER_ROLE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_USER_ROLE_TXNBTREE` (
  `user_id` int NOT NULL,
  `role_id` int NOT NULL,
  `create_time` bigint NOT NULL,
  `update_time` bigint NOT NULL,
  PRIMARY KEY (`user_id`,`role_id`)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='';
INSERT INTO myjarvex_txnbtree.REL_USER_ROLE_TXNBTREE (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_USERGROUP_ROLE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_USERGROUP_ROLE_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	role_id INTEGER NOT NULL,
	PRIMARY KEY (usergroup_id, role_id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='用户组与角色关联表';
INSERT INTO myjarvex_txnbtree.REL_USERGROUP_ROLE_TXNBTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS myjarvex_txnbtree.`REL_USERGROUP_USER_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`REL_USERGROUP_USER_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
	PRIMARY KEY (usergroup_id, user_id)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='用户组与用户关联表';
INSERT INTO myjarvex_txnbtree.REL_USERGROUP_USER_TXNBTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`RESOURCE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`RESOURCE_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
--	UNIQUE (name),
--	UNIQUE (`key`)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='资源信息表';
INSERT INTO myjarvex_txnbtree.RESOURCE_TXNBTREE (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`ROLE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`ROLE_TXNBTREE` (
  ...
  `update_time` bigint NOT NULL,
  PRIMARY KEY (`id`)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='角色表';
INSERT INTO myjarvex_txnbtree.`role_TXNBTREE` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`USER_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`USER_TXNBTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
	...
	PRIMARY KEY (id)
--	UNIQUE (name)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 COMMENT='用户表';
INSERT INTO myjarvex_txnbtree.`USER_TXNBTREE` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','myjarvex_txnbtree@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','myjarvex_txnbtree@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','myjarvex_txnbtree@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`USER_BASE_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`USER_BASE_TXNBTREE` (
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`USERGROUP_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`USERGROUP_TXNBTREE` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
  ...
  `update_time` bigint NOT NULL,
  PRIMARY KEY (`id`)
) engine=TXN_BTREE AUTO_INCREMENT = 1000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户组';
INSERT INTO myjarvex_txnbtree.`USERGROUP_TXNBTREE` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS myjarvex_txnbtree.`VECTOR_DATA_TXNBTREE`;
CREATE TABLE myjarvex_txnbtree.`VECTOR_DATA_TXNBTREE` (
