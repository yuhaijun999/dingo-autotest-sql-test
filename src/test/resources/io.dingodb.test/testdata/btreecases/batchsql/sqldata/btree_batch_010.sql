CREATE DATABASE IF NOT EXISTS jarvex_btree;
USE jarvex_btree;
DROP TABLE IF EXISTS jarvex_btree.`CHAT_QU_DATA_BTREE`;
CREATE TABLE jarvex_btree.`CHAT_QU_DATA_BTREE` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`CHAT_SE_DATA_BTREE`;
CREATE TABLE jarvex_btree.`CHAT_SE_DATA_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`COMMENT_BASE_INFO_BTREE`;
CREATE TABLE jarvex_btree.`COMMENT_BASE_INFO_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`CREATIVE_BASE_INFO_BTREE`;
CREATE TABLE jarvex_btree.`CREATIVE_BASE_INFO_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`CREATIVE_QU_DATA_BTREE`;
CREATE TABLE jarvex_btree.`CREATIVE_QU_DATA_BTREE` (
	user_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`CREATIVE_SE_DATA_BTREE`;
CREATE TABLE jarvex_btree.`CREATIVE_SE_DATA_BTREE` (
	creative_name VARCHAR(255),
	creative_des VARCHAR(255),
	create_time VARCHAR(255),
	creative_icon VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`DATA_FILE_BTREE`;
CREATE TABLE jarvex_btree.`DATA_FILE_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`DATA_FILE_EXPERTISE_BTREE`;
CREATE TABLE jarvex_btree.`DATA_FILE_EXPERTISE_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`DATA_FILEFT_BTREE`;
CREATE TABLE jarvex_btree.`DATA_FILEFT_BTREE` (
	data_name VARCHAR(255),
	data_des VARCHAR(255),
	user_id VARCHAR(255),
	dataset_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`DATA_FILESET_BTREE`;
CREATE TABLE jarvex_btree.`DATA_FILESET_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`DATA_FT_LIST_BTREE`;
CREATE TABLE jarvex_btree.`DATA_FT_LIST_BTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`DATASET_DINGO_BTREE`;
CREATE TABLE jarvex_btree.`DATASET_DINGO_BTREE` (
	data_id VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`DATASET_FT_LIST_BTREE`;
CREATE TABLE jarvex_btree.`DATASET_FT_LIST_BTREE` (
	data_id VARCHAR(255),
	chunk VARCHAR(255),
	question VARCHAR(255),
	answer VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`DEPARTMENT_BTREE`;
CREATE TABLE jarvex_btree.`DEPARTMENT` (
...
DROP TABLE IF EXISTS jarvex_btree.`MODEL_BASE_INFO_BTREE`;
CREATE TABLE jarvex_btree.`MODEL_BASE_INFO_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`OPERATION_BTREE`;
CREATE TABLE jarvex_btree.`OPERATION_BTREE` (
...
INSERT INTO jarvex_btree.OPERATION_BTREE (CREATE_TIME,UPDATE_TIME,NAME,CODE,`TYPE`,REMARK,ID) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`PERMISSION_BTREE`;
CREATE TABLE jarvex_btree.`PERMISSION_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	type VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex_btree.PERMISSION_BTREE (CREATE_TIME,UPDATE_TIME,`TYPE`,OPERATION_ID,RESOURCE_ID,REMARK,STATUS,ID) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`PERMISSIONGROUP_BTREE`;
CREATE TABLE jarvex_btree.`PERMISSIONGROUP_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	name VARCHAR(255) NOT NULL,
	label VARCHAR(255),
...
DROP TABLE IF EXISTS jarvex_btree.`REL_PGROUP_PERMISSION_BTREE`;
CREATE TABLE jarvex_btree.`REL_PGROUP_PERMISSION_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex_btree.`REL_PGROUP_PERMISSION_BTREE` (CREATE_TIME,UPDATE_TIME,PGROUP_ID,PERMISSION_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`REL_ROLE_PERMISSION_BTREE`;
CREATE TABLE jarvex_btree.`REL_ROLE_PERMISSION_BTREE` (
...
INSERT INTO jarvex_btree.REL_ROLE_PERMISSION_BTREE (ROLE_ID,PERMISSION_ID,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`REL_ROLE_PGROUP_BTREE`;
CREATE TABLE jarvex_btree.`REL_ROLE_PGROUP_BTREE` (
	`create_time` bigint NOT NULL,
    `update_time` bigint NOT NULL,
...
INSERT INTO jarvex_btree.REL_ROLE_PGROUP_BTREE (CREATE_TIME,UPDATE_TIME,ROLE_ID,PGROUP_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`REL_USER_PERMISSION_BTREE`;
CREATE TABLE jarvex_btree.`REL_USER_PERMISSION_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
DROP TABLE IF EXISTS jarvex_btree.`REL_USER_ROLE_BTREE`;
CREATE TABLE jarvex_btree.`REL_USER_ROLE_BTREE` (
...
INSERT INTO jarvex_btree.REL_USER_ROLE_BTREE (user_id,role_id,create_time,update_time)
values
(1,1,1702282318591,1702282318591);
DROP TABLE IF EXISTS jarvex_btree.`REL_USERGROUP_ROLE_BTREE`;
CREATE TABLE jarvex_btree.`REL_USERGROUP_ROLE_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
...
INSERT INTO jarvex_btree.REL_USERGROUP_ROLE_BTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,ROLE_ID) VALUES
	 (1703060370502,1703060370502,3,4),
	 (1703060370502,1703060370502,4,5);
DROP TABLE IF EXISTS jarvex_btree.`REL_USERGROUP_USER_BTREE`;
CREATE TABLE jarvex_btree.`REL_USERGROUP_USER_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	usergroup_id INTEGER NOT NULL,
	user_id INTEGER NOT NULL,
...
INSERT INTO jarvex_btree.REL_USERGROUP_USER_BTREE (CREATE_TIME,UPDATE_TIME,USERGROUP_ID,USER_ID) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`RESOURCE_BTREE`;
CREATE TABLE jarvex_btree.`RESOURCE_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	parent_id INTEGER,
...
INSERT INTO jarvex_btree.RESOURCE_BTREE (CREATE_TIME,UPDATE_TIME,ID,PARENT_ID,NAME,`TYPE`,REL_ID,`KEY`,REMARK,STATUS) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`ROLE_BTREE`;
CREATE TABLE jarvex_btree.`ROLE_BTREE` (
...
INSERT INTO jarvex_btree.`role_BTREE` (ID,NAME,NICK_NAME,LABEL,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`USER_BTREE`;
CREATE TABLE jarvex_btree.`USER_BTREE` (
	create_time BIGINT NOT NULL,
	update_time BIGINT NOT NULL,
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(255) NOT NULL,
...
INSERT INTO jarvex_btree.`USER_BTREE` (CREATE_TIME,UPDATE_TIME,ID,NAME,PASSWORD,NICK_NAME,PHONE,EMAIL,STATUS,REMARK,EXPIRE_TIME) VALUES
	 (1701429522047,1701429522047,1,'admin','$2b$12$Ja/WHlzqIJKJmeQ3/8ArOeEUz73eE6q9TJRGiqx.qBNC3Vo/FkAV6','超级管理员','','jarvex_btree@zetyun.com',1,'系统默认超级管理员',NULL),
	 (1701429522047,1701429522047,2,'manager','$2b$12$vrRjeO4g30btUNP41QYS2eWW3orp2HjdRrCdFvSX/BhfG7yTWT5Em','系统普通管理员','','jarvex_btree@zetyun.com',1,'管理员',NULL),
	 (1701429522047,1701429522047,3,'guest','$2b$12$MY/yxv5i8hoZquBl.dka8ep5JVDUd1xkQ.EtVbVr72VjMPFKzHeLi','访客','','jarvex_btree@zetyun.com',1,'系统默认访客',NULL),
...
DROP TABLE IF EXISTS jarvex_btree.`USER_BASE_BTREE`;
CREATE TABLE jarvex_btree.`USER_BASE_BTREE` (
...
DROP TABLE IF EXISTS jarvex_btree.`USERGROUP_BTREE`;
CREATE TABLE jarvex_btree.`USERGROUP_BTREE` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255)  NOT NULL,
  `label` varchar(255)  NOT NULL,
...
INSERT INTO jarvex_btree.`USERGROUP_BTREE` (ID,NAME,LABEL,REMARK,STATUS,CREATE_TIME,UPDATE_TIME) VALUES
...
DROP TABLE IF EXISTS jarvex_btree.`VECTOR_DATA_BTREE`;
CREATE TABLE jarvex_btree.`VECTOR_DATA_BTREE` (
